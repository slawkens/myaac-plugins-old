...
<?php
		...
		foreach($countries as $v) {
			echo "['" . (isset($config['countries'][$v['country']]) ? $config['countries'][$v['country']] : 'Unknown') . "', " . $v['amount'] . "]" . ',';
		}
		...
		echo "['Other', " . (isset($v['other']) ? $v['other'] : '0') . "]";
?>
	]);
...
<div id="sexs" style="width: 100%; height: 300px;"></div>
<?php if($config['account_country']): ?>
