...
Attribution:
    ...
    * Must include the provided credit links to my website in the footer.

This means that you are free to use and modify the templates & themes for any purpose as long as you include the provided credit links to my website in the footer.
...
This gives you permission to remove the provided credit links on one template for one domain, for a corporate license (unlimited use on unlimited domains) please contact me.
...
>> Note
-------------------------------------------------
Removing the credit links (not paid for) is the same as breaking the law and legal action can be taken against you.
