...
$config['powerful_guilds'] = [
	...
	'amount' => 4, // how many powerful guilds to show
];

$db->query("SET SESSION sql_mode=(SELECT REPLACE(@@sql_mode,'ONLY_FULL_GROUP_BY',''));");

if (!function_exists('mostPowerfulGuildsDatabase')) {
...
if (!function_exists('mostPowerfulGuildsList')) {
...
$twig->display('top_guilds.html.twig', [
	'guilds' => $guilds
]);
